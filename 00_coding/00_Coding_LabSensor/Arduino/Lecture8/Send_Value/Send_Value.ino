...
const char* ssid = "-XIV-5s"; //Change to your SSID
const char* password = "wp127001"; //Change to your PW
const char* host = "172.20.10.6"; //Change to your computer IP address
int value=0;
WiFiClient client;
